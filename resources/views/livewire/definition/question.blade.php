<div class="d-flex justify-content-evenly">
        ...
        <div class="accordion" id="accordionExample">
            ...
            <div class="card">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                    <div class="card-body">
                        <p>
                            No painel de administrador vá para “[Nome da secção da Loja]” e adira ao WhatsApp. Como elemento premium tem um custo mensal
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header" id="headingThree">
                    <h6 class="mb-0" style="cursor: pointer;" data-toggle="collapse" data-target="#question2" aria-expanded="false" aria-controls="collapseThree">
            ...
            <div class="card">
                <div class="card-header" id="headingThree">
                    <h6 class="mb-0" style="cursor: pointer;" data-toggle="collapse" data-target="#question3" aria-expanded="false" aria-controls="collapseThree">
    ...
    <div class="col-xl-6">
        <div style="width: 5rem">
            <img width="580" src="{{asset("assets/img/question.svg")}}" alt="">
        </div>
    </div>
</div>